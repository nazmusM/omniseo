...
<div class="main">
    ...
    <div class="contact-container">
        <div class="contact-info">
            ...
            <div class="info-item">
                ...
                <div class="info-content">
                    <h3>Email Us</h3>
                    <p><a href="mailto:support@omniseo.com">support@omniseo.com</a></p>
                    <p><a href="mailto:sales@omniseo.com">sales@omniseo.com</a></p>
                </div>
            </div>
            ...
            <div class="info-item">
                ...
                <div class="info-content">
                    <h3>Visit Us</h3>
                    <p>123 AI Drive, Tech City</p>
                    <p>TC 12345, United States</p>
                </div>
            </div>
        ...
        <div class="contact-form-container">
            ...
            <form id="contact-form" class="contact-form" method="POST" action="../includes/send-contact.php">
                <div class="form-row">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        contactForm.addEventListener('submit', function(e) {
            ...
            setTimeout(() => {
                ...
                // to submit the form data to your server
